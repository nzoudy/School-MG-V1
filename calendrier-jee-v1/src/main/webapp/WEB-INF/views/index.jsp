...
<body>
	...
	<div id="content-index">
		...
		<div class="main-entry">
			<img alt="" src="<%=request.getContextPath()%>/resources/images/main-entry.png">
		</div>
		
		<div class="description">
			<p> Le cursus d’Ingésup est conçu comme un programme
				...
				futur rôle d’expert dans l’entreprise <br></p>
		</div>
		
		<div class="other">
			<img alt="" src="<%=request.getContextPath()%>/resources/images/other.png">
		</div>
